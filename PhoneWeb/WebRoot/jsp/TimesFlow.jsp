...
<script type="text/javascript">
			 ...
			 //实例化流量按日统计面板
			 var _showTimesFlowPanel=new TimesFlowPanel({myid:subMainId});
			 //设置宽度
			 _showTimesFlowPanel.width=w;
			 //设置高度
			 _showTimesFlowPanel.height=h;
			 //渲染组件
			 _showTimesFlowPanel.render(subMainId+'p');
</script>