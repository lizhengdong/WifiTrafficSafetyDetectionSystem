...
<script type="text/javascript">
			 ...
			 //实例化系统设置面板
			 var _showWifiSafetyConfigPanel=new WifiSafetyConfigPanel({myid:subMainId});
			 //设置宽度
			 _showWifiSafetyConfigPanel.width=w;
			 //设置高度
			 _showWifiSafetyConfigPanel.height=h;
			 //渲染组件
			 _showWifiSafetyConfigPanel.render(subMainId+'p');
			 
			 //_showWifiSafetyConfigPanel.loadForm();
</script>