...
<script type="text/javascript">
			 ...
			 //实例化系统工具面板
			 var _showNetworkParameterPanel=new NetworkParameterPanel({myid:subMainId});
			 //设置宽度
			 _showNetworkParameterPanel.width=w;
			 //设置高度
			 _showNetworkParameterPanel.height=h;
			 //渲染组件
			 _showNetworkParameterPanel.render(subMainId+'p');
			 
			 //_showSystemToolsPanel.loadForm();
</script>
