...
<script type="text/javascript">
			 ...
			 //实例化系统设置面板
			 var _showSystemConfigPanel=new SystemConfigPanel({myid:subMainId});
			 //设置宽度
			 _showSystemConfigPanel.width=w;
			 //设置高度
			 _showSystemConfigPanel.height=h;
			 //渲染组件
			 _showSystemConfigPanel.render(subMainId+'p');
			 
			 _showSystemConfigPanel.loadForm();
</script>