...
<script type="text/javascript">
			 ...
			 //实例化流量按日统计面板
			 var _showAccessControlPanel=new AccessControlPanel({myid:subMainId});
			 //设置宽度
			 _showAccessControlPanel.width=w;
			 //设置高度
			 _showAccessControlPanel.height=h;
			 //渲染组件
			 _showAccessControlPanel.render(subMainId+'p');
</script>