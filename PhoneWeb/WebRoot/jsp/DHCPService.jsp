...
<script type="text/javascript">
			 ...
			 //实例化系统工具面板
			 var _showDHCPServicePanel=new DHCPServicePanel({myid:subMainId});
			 //设置宽度
			 _showDHCPServicePanel.width=w;
			 //设置高度
			 _showDHCPServicePanel.height=h;
			 //渲染组件
			 _showDHCPServicePanel.render(subMainId+'p');
			 
			 _showDHCPServicePanel.loadForm();
</script>