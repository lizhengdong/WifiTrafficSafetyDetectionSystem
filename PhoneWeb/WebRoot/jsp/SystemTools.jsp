...
<script type="text/javascript">
			 ...
			 //实例化系统工具面板
			 var _showSystemToolsPanel=new SystemToolsPanel({myid:subMainId});
			 //设置宽度
			 _showSystemToolsPanel.width=w;
			 //设置高度
			 _showSystemToolsPanel.height=h;
			 //渲染组件
			 _showSystemToolsPanel.render(subMainId+'p');
