...
<script type="text/javascript">
			 ...
			 //实例化手机安全状态面板
			 var _showPhoneSafetyPanel=new PhoneSafetyPanel({myid:subMainId});
			 //设置宽度
			 _showPhoneSafetyPanel.width=w;
			 //设置高度
			 _showPhoneSafetyPanel.height=h;
			 //渲染组件
			 _showPhoneSafetyPanel.render(subMainId+'p');
</script>