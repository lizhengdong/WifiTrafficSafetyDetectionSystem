...
<script type="text/javascript">
			 ...
			 //实例化系统工具面板
			 var _showWifiBasicConfigPanel=new WifiBasicConfigPanel({myid:subMainId});
			 //设置宽度
			 _showWifiBasicConfigPanel.width=w;
			 //设置高度
			 _showWifiBasicConfigPanel.height=h;
			 //渲染组件
			 _showWifiBasicConfigPanel.render(subMainId+'p');
			 
			 _showWifiBasicConfigPanel.loadForm();
</script>
